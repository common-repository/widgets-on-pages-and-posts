...
<div id="fs_connect"
	...
	<div class="fs-content">
		...
		<p><?php
				...
				if ( $is_pending_activation ) {
					...
					$filter                = 'Thank you for plugin installation';
					$default_optin_message = 'Thank you for plugin installation';
	...
	<a style="margin:20px;" href="<?php echo fs_nonce_url( $fs->_get_admin_page_url( '', array( 'fs_action' => $slug . '_skip_activation' ) ), $slug . '_skip_activation' ) ?>"
			   class="button button-secondary" tabindex="2">Open Widgets on Pages plugin</a>
			   <?php /*
